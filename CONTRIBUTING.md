# Contributing to ugv_nav4d_ros2
...
The preferred way to contribute to ugv_nav4d_ros2 is to fork the
[main repository](https://github.com/dfki-ric/ugv_nav4d_ros2) on GitHub, then submit a "pull request"
(PR):

1. [Create an account](https://github.com/signup/free) on
   GitHub if you do not already have one.

2. Fork the [project repository](https://github.com/dfki-ric/ugv_nav4d_ros2):
   click on the 'Fork' button near the top of the page. This creates a copy of
   the code under your account on the GitHub server.

3. Clone this copy to your local disk:

        $ git clone git@github.com:YourLogin/ugv_nav4d_ros2.git
...
Finally, go to the web page of the your fork of the ugv_nav4d_ros2 repo,
